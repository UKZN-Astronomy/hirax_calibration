...
---> Added the SiderealStream_all_sources function, TimeStream_all_sources class and empty_timestream_all_sources function
"""
...
class SiderealStream_all_sources(ContainerBase):
    """A container for holding a visibility dataset in sidereal time.
    ...
    _axes = ("source", "freq", "prod", "stack", "input", "ra")

    _dataset_spec = {
        "vis": {
            "axes": ["source", "freq", "stack", "ra"],
            "dtype": np.complex64,
            "initialise": True,
            "distributed": True,
            "distributed_axis": "freq",
    ...
    def __init__(self, ra=None, *args, **kwargs):
        ...
        super(SiderealStream_all_sources, self).__init__(*args, **kwargs)
...
class TimeStream_all_sources(TODContainer):
    ...
    _axes = ("source", "freq", "prod", "stack", "input", "time")

    _dataset_spec = {
        "vis": {
            "axes": ["source", "freq", "stack", "time"],
            "dtype": np.complex64,
            "initialise": True,
            "distributed": True,
            "distributed_axis": "freq",
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(TimeStream_all_sources, self).__init__(*args, **kwargs)
...
def empty_timestream_all_sources(**kwargs):
    """Create a new timestream container.
    ...
    ts : TimeStream
    """
    return TimeStream_all_sources(**kwargs)
