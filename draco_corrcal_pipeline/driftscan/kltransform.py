...
'''Added the point_source_unresolved function'''
...
class KLTransform(config.Reader):
    ...
    def point_source_unresolved(self):
        """Compute the unresolved point source covariance matrix (on the sky).

        Returns
        -------
        cv_ps : np.ndarray[pol2, pol1, l, freq1, freq2]
        """


        self._cvps = skymodel.point_source_unresolved_model(
